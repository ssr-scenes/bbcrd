...
<asdf
    ...
    <scene_setup>
        ...
        <source name="110" model="point" properties_file="irs/SBSBRIR_x0y0_LS110deg.wav" volume="0">
          <port>4</port>
          <position x="-1.97" y="-0.72" fixed="true"/>
        </source>
        <source name="250" model="point" properties_file="irs/SBSBRIR_x0y0_LS250deg.wav" volume="0">
          <port>5</port>
          <position x="1.97" y="-0.72" fixed="true"/>
        </source>
